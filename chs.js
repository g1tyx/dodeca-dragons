...
var cnItems = {
    ...
    "Increase platinum gain tenfold (": "增加白金增益十倍（",
    "Increase uranium gain by 10% (additive) (": "增加铀增益 10%（加法）（",
    "Keep platinum upgrades on magic reset": "在魔法重置时保持白金升级",
    ...
    "times, increasing fire gain by ^": "次，增加四倍增益 ^",
    ...
    "Unlock a new platinum upgrade (kept on reset)": "解锁新的白金升级（保持重置）",
    "Unlock buy max and max all for fire upgrades": "解锁 Buy max 和 max all 进行四次升级",
    "Unlock fire upgrades": "解锁四个升级",
    "Unlock max all for platinum upgrades": "为白金升级解锁最大全部",
