...
const achievementNames = [
  ...
  ["Hey, it's like the name of the game! :O", "Dodecadamned", "Dodecadimensional", "Dodecalculus", "Dodecadeadly", "Dodecadangerous", "Dodecalculated", "Dodechaotic", "Dodecadivine", "Dodecadestructive", "Dodecades of work", "Dodecomplete"],
	//Planets
	["Mr. Worldwide", "The system", "Spacetime jumping", "Extreme acceleration", "Super Jupiter", "Brown dwarf", "Dyson spheres", "Dark matter pockets", "Non-Euclidean planets"],
	//Omniversal hypergods
	["This is the final achievement row.", "You have come an incredibly long way.", "Your desire for power is unending.", "All who have tried to stop you have failed.", "There mustn't be long to go now."]
]
const achievementRequirements = [
  ...
  ["1", "3", "10", "50", "2500", "1000000", "1e9", "1e18", "1e30", "1e80", "1e250", "1e1000"],
	//Planets
	["1", "5", "10", "25", "75", "250", "500", "1200", "4000"],
	//Omniversal hypergods
...
const achievementRewards = {
  ...
  ach23x2: "Gain 100% of potential R-O-Y sigils per second!",
	...
	ach23x5: "Unlock Buy Max buttons for cosmic plague upgrades!",
	//Omniversal hypergods
	...
	ach24x3: "A 5x essence gain multiplier!",
}
