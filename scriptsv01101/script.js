...
function reset() {
  ...
  for (i=3;i<43;i++) { //The x in i<x should always be equal to the number of tabs (final tab number plus 1)
    if (i != 18) document.getElementsByClassName("box")[i].style.display = "none"
  }
  for (i=1;i<29;i++) document.getElementsByClassName("resourceRow")[i].style.display = "none"
  ...
  document.getElementById("maxOrangeSigilUpgradesButton").style.display = "none"
	...
	document.getElementsByClassName("plagueUpgrade")[4].style.display = "none"
	document.getElementsByClassName("plagueBuyMaxButton")[5].style.display = "none"
...
function loadGame(loadgame) {
  ...
  if (game.unlocks >= 22) {
    ...
    redSigilAutoOption.value = "Orange"
  ...
  if (game.unlocks >= 23) {
    ...
    redSigilAutoOption.value = "Yellow"
...
function updateSmall() {
  ...
  if (game.unlocks >= 28) {
	...
	if (game.unlocks >= 29) {
		...
		if (game.voidMagicUpgradesBought[14] == true) {
	...
	if (game.unlocks >= 33) {
		...
		document.getElementById("lightEssenceMultiplier").innerHTML = format(game.darkEssence.add(1).log10().add(1), 2)
...
function updateLarge() {
  ...
  game.gold = game.gold.add(game.goldPerSecond.div(2))
